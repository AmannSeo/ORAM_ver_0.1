...
const SAAS_INFO: Record<SaasType, {
  ...
  SLACK: {
    ...
    steps: [
      ...
      '계정 수집만 할 경우 Bot Token Scopes: users:read, users:read.email 추가',
      '퇴사자 접근 차단까지 하려면 User Token Scopes: admin.users:write 추가\n  ※ admin.users:write는 Enterprise Grid에서만 동작합니다.',
      '"Install to Workspace" 또는 "Reinstall to Workspace" 클릭 → 관리자 계정으로 승인',
      '"OAuth Tokens" 섹션에서 토큰 복사\n  - xoxb-: 사용자 수집 가능, 접근 차단 불가\n  - xoxp-: Enterprise + admin.users:write일 때 접근 차단 가능',
