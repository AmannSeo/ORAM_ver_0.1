...
const WORKFLOW_STEPS = [
  ...
  },
  {
    ...
    detail: [
      '관리자 권한, Owner 권한, API 토큰 여부, 최근 로그인, 저장소/워크스페이스 범위 등을 점수에 반영합니다.',
      'XGBoost 기반 분석기를 사용하고, 모델 사용이 어려운 경우 fallback 가중치 방식으로 계산합니다.',
      'AI 리스크 분석 화면에서는 점수, 감지 근거, 권장 판단을 확인합니다.',
    ],
  },
  {
    title: '5. 관리자 판단',
