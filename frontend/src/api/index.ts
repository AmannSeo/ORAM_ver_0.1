...
export const saasApi = {
  ...
  tokenConnect: (saasType: SaasType, token: string, workspaceName?: string, accountScope?: string) =>
    api.post<SaasConnection>(`/saas-connections/token-connect/${saasType}`, { token, workspaceName, accountScope }).then((r) => r.data),
